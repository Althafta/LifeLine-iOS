...
//                delegate.initializeMyCourse()
    ...
    func askForEmailAlert(dicDetails:NSDictionary) {
        ...
        let emailAlert = UIAlertController(title: NSLocalizedString("Enter your email ID", comment: "") , message: "Your mail ID cannot be fetched from Facebook", preferredStyle: UIAlertController.Style.alert)
        ...
        emailAlert.addAction(UIAlertAction(title: NSLocalizedString("Send", comment: ""), style: UIAlertAction.Style.default, handler: { (alert) -> Void in
        ...
        emailAlert.addAction(UIAlertAction(title: NSLocalizedString("Cancel", comment: ""), style: UIAlertAction.Style.destructive, handler: { (alert) -> Void in
